...
typedef freq_t* count_result_t;

/**
 * @brief computes the frequency of appeareance of letters in a text file.
 *
 * This function takes as argument the name of a file, and returns a count_result_t 
 ...
 * @return a count_result_t with the correct frequencies for each letter.
 */
